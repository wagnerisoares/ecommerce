<%-- 
    ...
    Created on : 27/09/2015, 13:05:49
    ...
    <body>
        ...
        <%
            ...
            if (request.getParameter("btnAltera") != null) {
                ...
                produto = new Produto(codigo, descricao, preco, categoria, estoque);
                boolean alterou = ProdutoDB.alteraProduto(produto, conexao);
                if (alterou) {
                    mensagem = "Produto alterado com sucesso!";
                } else {
                    mensagem = "Erro ao alterar o cliente - entra em contato com o suporte tecnico!";
                }
            }
        ...
        <div class="container-fluid">
            <form name="frmAlterar" method="post" class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="descricao" maxlength="100"  class="form-control" id="inputEmail3" placeholder="Descricao" value="<%= produto.getDescricao()%>"/>
                    </div>
                    <label for="inputEmail3" class="col-sm-2 control-label">Preço:</label>
                    <div class="col-sm-9">
                        <input type="text" name="preco" maxlength="100"  class="form-control" id="inputEmail3" placeholder="Preço" value="<%= produto.getPreco()%>"/>
                    </div>
                    <label for="inputEmail3" class="col-sm-2 control-label">Categoria:</label>
                    <div class="col-sm-9">
                        <input type="text" name="categoria" maxlength="100"  class="form-control" id="inputEmail3" placeholder="Categoria" value="<%= produto.getCategoria()%>"/>
                    </div>
                    <label for="inputEmail3" class="col-sm-2 control-label">Estoque:</label>
                    <div class="col-sm-9">
                        <input type="text" name="estoque" maxlength="100"  class="form-control" id="inputEmail3" placeholder="Estoque" value="<%= produto.getEstoque()%>"/>
                    </div>
